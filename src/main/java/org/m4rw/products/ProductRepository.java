...
public interface ProductRepository {
     ...
     * @param product
     * @throws DuplicateProductException when the collection already contains the specified productCode
     */
    void addNewProduct(String productCode, Product product) throws DuplicateProductException;
